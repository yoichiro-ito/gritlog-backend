...
import reflection.IReflectionRepository
import reflection.ReflectionDto
import reflection.ReflectionSearchForm
...
class ReflectionRepository(
    ...
    override fun search(cond: ReflectionSearchForm, limit: Long): List<ReflectionDto> =
        query.selectFrom(reflectionEntity)
            .where(listOfNotNull(
    ...
    private fun List<BooleanExpression>.toAnd(): BooleanExpression? =
        this.reduceOrNull { acc, exp -> acc.and(exp) }
}